...
const canvas4 = document.querySelector('#canvas4') as HTMLCanvasElement;
const ctx4 = canvas4.getContext('2d');
canvas4.width = 600;
canvas4.height = 600;

const canvas5 = document.querySelector('#canvas5') as HTMLCanvasElement;
...
// Hiệu ứng gợn sóng
const ripplesArray : Particle[] = [];
// Vật cản : Xe
const carsArray : Obstacle[] = [];
// Vật cản : khúc cây
const logsArray : Obstacle[] = [];
// images
