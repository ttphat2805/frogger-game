"use strict";
function start() {
    ctx1 === null || ctx1 === void 0 ? void 0 : ctx1.clearRect(0, 0, canvas.width, canvas.height);
    ctx2 === null || ctx2 === void 0 ? void 0 : ctx2.clearRect(0, 0, canvas.width, canvas.height);
    ctx3 === null || ctx3 === void 0 ? void 0 : ctx3.clearRect(0, 0, canvas.width, canvas.height);
    ctx4 === null || ctx4 === void 0 ? void 0 : ctx4.clearRect(0, 0, canvas.width, canvas.height);
    ctx5 === null || ctx5 === void 0 ? void 0 : ctx5.clearRect(0, 0, canvas.width, canvas.height);
    handleParticle();
    ctx2 === null || ctx2 === void 0 ? void 0 : ctx2.drawImage(background_main, 0, 0, canvas.width, canvas.height);
    handleRipples();
    frogger.draw();
    frogger.update();
    frame++;
